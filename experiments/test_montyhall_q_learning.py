#!/usr/bin/env python3
"""
Test Q-Learning sur Monty Hall avec visualisation PyGame.
"""
...
def test_q_learning_monty_hall():
    print("=== Test Q-Learning sur Monty Hall ===")
    env = MontyHall()
    visualizer = MontyHallVisualizer()
    algo = QLearning(environment=env, num_episodes=5000, gamma=0.99, alpha=0.1, epsilon=0.1)
    print("Entraînement...")
    results = algo.train()
