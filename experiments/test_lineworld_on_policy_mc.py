...
def test_lineworld_on_policy_mc():
    """Test de On-Policy Monte Carlo Control sur LineWorld."""
    print("=== ON-POLICY MONTE CARLO CONTROL SUR LINEWORLD ===")
    print("Test de l'algorithme On-Policy Monte Carlo Control sur LineWorld")
    print()
