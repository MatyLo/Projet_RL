#!/usr/bin/env python3
"""
Test SARSA sur Monty Hall avec visualisation PyGame.
"""
...
def test_sarsa_monty_hall():
    print("=== Test SARSA sur Monty Hall ===")
    env = MontyHall()
    visualizer = MontyHallVisualizer()
    algo = Sarsa(environment=env, num_episodes=5000, gamma=0.99, alpha=0.1, epsilon=0.1)
    print("Entraînement...")
    results = algo.train()
