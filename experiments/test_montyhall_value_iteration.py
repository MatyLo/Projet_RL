#!/usr/bin/env python3
"""
Test de Value Iteration sur l'environnement Monty Hall avec visualisation PyGame.
"""
...
def test_value_iteration_monty_hall():
    """Test de Value Iteration sur Monty Hall avec visualisation."""
    
    print("=== Test Value Iteration sur Monty Hall ===")
    ...
    print("Création de l'algorithme Value Iteration...")
    
    # Créer l'algorithme Value Iteration
    ...
    training_results = value_iteration.train()
    ...
    # Utiliser la politique optimale directement
    ...
    for episode in range(test_episodes):
        ...
        while True:
            # Choisir l'action selon la politique optimale
            if env.state == 0:
                # Choix initial - choisir une porte aléatoirement
                action = np.random.choice([0, 1, 2])
            else:
                # Action rester/changer selon la politique optimale
...
if __name__ == "__main__":
    test_value_iteration_monty_hall() 