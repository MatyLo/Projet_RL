#!/usr/bin/env python3
"""
Test On-Policy Monte Carlo Control sur Monty Hall avec visualisation PyGame.
"""
...
def test_on_policy_mc_monty_hall():
    print("=== Test On-Policy Monte Carlo Control sur Monty Hall ===")
    env = MontyHall()
    visualizer = MontyHallVisualizer()
    algo = OnPolicyFirstVisitMCControl(environment=env, num_episodes=5000, gamma=0.99, epsilon=0.1)
    print("Entraînement...")
    results = algo.train()
